...
public class NMapCalloutBasicOverlay extends NMapCalloutOverlay {
	...
	private static final int CALLOUT_TAG_WIDTH = 50;
	private static final int CALLOUT_TAG_HEIGHT = 50;
	private static final int CALLOUT_ROUND_RADIUS_X = 10;
	private static final int CALLOUT_ROUND_RADIUS_Y = 10;
	...
	public NMapCalloutBasicOverlay(NMapOverlay itemOverlay, NMapOverlayItem item, Rect itemBounds) {
		...
		mInnerPaint.setARGB(255, 161, 214, 227); //skyblue
