...
public class BoardW extends JFrame {
	...
	public void actioncomp() {
		comp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				try {
					File k = new File(Variable.Subject + "의 게시판]게시물 수.txt");
					if (k.exists()) {
					...
					write1 = new FileWriter(Variable.Subject
							+ "의 게시판]titles.txt", true);
					write1.write( rno + ") " + ytitle
							+ " (작성자: " + ynn + ")" + "\n");
					write1.close();
					
					write2 = new FileWriter(Variable.Subject + "의 게시판]" + num
							+ ".txt");
					write2.write(Variable.UserName+"\n"+yct);
